...
fn language_name_from_language_code(
    ...
    if use_country_code {
        ...
        match normalized.as_str() {
            ...
            "ru-by" => return "Русский (Беларусь)",
            "ru-kg" => return "Русский (Киргизия)",
            "ru-kz" => return "Русский (Казахстан)",
            "ru-md" => return "Русский (Молдова)",
            "ru-ru" => return "Русский (Россия)",
            "ru-ua" => return "Русский (Украина)",
            ...
            "ru-blr" => return "Русский (Беларусь)",
            "ru-kaz" => return "Русский (Казахстан)",
            "ru-kgz" => return "Русский (Кыргызстан)",
            "ru-mda" => return "Русский (Молдова)",
            "ru-rus" => return "Русский (Россия)",
            "ru-ukr" => return "Русский (Украина)",
